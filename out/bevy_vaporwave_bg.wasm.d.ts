...
export function closure4378_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1f5cfe27a5b3154d(a: number, b: number): void;
export function closure4381_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7d269ac388edc087(a: number, b: number): void;
export function closure73732_externref_shim(a: number, b: number, c: number): void;
